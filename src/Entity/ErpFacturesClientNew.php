...
#[ORM\Entity(repositoryClass: ErpFacturesClientNewRepository::class)]
class ErpFacturesClientNew
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\Column(type: Types::TEXT)]
    private ?string $champ_demande_new = null;
    ...
    #[ORM\Column(type: Types::TEXT)]
    private ?string $numbercompte = null;

    #[ORM\Column(type: Types::TEXT)]
    private ?string $montantsaisie = null;

    #[ORM\Column(type: Types::TEXT)]
    private ?string $accomptesaisie = null;
    ...
    public function getChampDemandeNew(): ?string
    {
        return $this->champ_demande_new;
    }

    public function setChampDemandeNew(string $champ_demande_new): static
    {
        $this->champ_demande_new = $champ_demande_new;
    ...
    public function setNumbercompte(string $numbercompte): static
    {
    ...
    public function getAccomptesaisie(): ?string
    {
        return $this->accomptesaisie;
    }

    public function setAccomptesaisie(string $accomptesaisie): static
    {
        $this->accomptesaisie = $accomptesaisie;
    ...
    public function setEtatfacture(string $etatfacture): static
    {
