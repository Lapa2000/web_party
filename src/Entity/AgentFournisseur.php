...
#[ORM\Entity(repositoryClass: AgentFournisseurRepository::class)]
class AgentFournisseur
{
    ...
    #[ORM\Column(type: Types::TEXT)]
    private ?string $adresseadministratif = null;
    ...
    public function setAdresseadministratif(string $adresseadministratif): static
    {
